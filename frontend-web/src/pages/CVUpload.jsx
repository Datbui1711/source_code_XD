...
function CVUpload() {
  ...
  const extractTextFromPDF = async (file) => {
    try {
      ...
      throw new Error('Không thể đọc file PDF. Vui lòng thử:\n1. Chuyển đổi PDF sang file Word (.docx)\n2. Copy/paste nội dung CV vào ô text\n3. Thử file PDF khác');
    }
  };
              ...
              <div style={{ border: '2px dashed #cbd5e1', borderRadius: '12px', padding: '3rem 2rem', textAlign: 'center', marginBottom: '1.5rem', background: '#f8fafc' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
                  {parsing ? (
                    ...
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14 2H6C4.9 2 4.01 2.9 4.01 4L4 20C4 21.1 4.89 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20Z" fill="#64748b"/>
                    </svg>
                  )}
                </div>
              ...
              <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '2rem' }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%)', borderRadius: '12px', padding: '1.5rem', marginBottom: '1.5rem', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '3rem', fontWeight: '700', color: '#047857' }}>
                    {analysis.overall_score || analysis.score || 0}/100
                  </div>
                  <div style={{ color: '#059669', fontSize: '0.9rem', marginTop: '0.5rem' }}>
                    {(analysis.overall_score || analysis.score || 0) >= 80 ? 'Xuất sắc!' : (analysis.overall_score || analysis.score || 0) >= 70 ? 'Tốt!' : 'Cần cải thiện'}
                  </div>
                </div>
                ...
                {/* Strengths */}
                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ color: '#0f172a', fontWeight: '600', marginBottom: '0.75rem', fontSize: '1.05rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
